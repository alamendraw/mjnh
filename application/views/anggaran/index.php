            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div style="float:right;"> 
                        <a href="<?php echo $url.'/add/1';?>" class="btn btn-icon btn-outline-primary btn-sm" data-toggle="tooltip" data-original-title="Anggaran Pendapatan"> <i class="feather icon-plus"></i> Anggaran Pendapatan</a>
                        <a href="<?php echo $url.'/add/2';?>" class="btn btn-icon btn-outline-success btn-sm" data-toggle="tooltip" data-original-title="Anggaran Pengeluaran"> <i class="feather icon-plus"></i> Anggaran Pengeluaran</a>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table zero-configuration" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo $no++;?></td>
                                        <td><?php echo $row->kd_rek1.'.'.$row->kd_rek2.'.'.$row->kd_rek3.'.'.$row->sort_by;?></td> 
