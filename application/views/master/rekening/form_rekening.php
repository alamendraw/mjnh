        ...
        <div class="col-md-6 col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body"> 
                        <form id="form" action="<?php echo site_url('master/rekening/rekening/save')?>" method="post" enctype="multipart/form-data"  autocomplete="off">
                            <div class="row">
                                <div class="col-sm-12">
                                <input type="hidden" name="action" class="form-control" value="<?php echo $action;?>" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <select class="form-control" name="kd_rek2" required>
