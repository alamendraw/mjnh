            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div style="float:right;"> 
                        <a href="<?php echo $url.'/add';?>" class="btn btn-icon btn-outline-primary btn-sm" data-toggle="tooltip" data-original-title="Tambah"> <i class="feather icon-plus"></i> Tambah Data</a>
                    </div>
                </div>
                            ...
                            <table class="table zero-configuration" width="100%">
                                <thead>
                                    <tr>
                                        <th width="5%">No</th>
                                        <th width="50%">Nama</th>
                                        <th width="10%">Kode Rekening 1</th>  
                                        <th width="10%">Kode Rekening 2</th>  
