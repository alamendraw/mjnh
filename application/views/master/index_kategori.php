            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div style="float:right;"> 
                        <a href="<?php echo site_url('master/kategori/add');?>" class="btn btn-icon btn-outline-primary btn-sm" data-toggle="tooltip" data-original-title="Tambah"> <i class="feather icon-plus"></i> Tambah Data</a>
                    </div>
                </div>
                            ...
                            <table class="table zero-configuration" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo ($row->type == 'P')?'Pendapatan':'Belanja';?></td>
                                        <td> 
