                                    ...
                                    <div class="card rounded-0 mb-0 p-2">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-0">
                                                <form action="<?php echo site_url('register/signup');?>">
                                                    
                                                    <div class="form-label-group">
                                                        <input type="text" name="mosquecode" id="inputMosqueCode" class="form-control" placeholder="Mosque Code" required>
                                                        <label for="inputMosqueCode">Mosque Code</label>
                                                    </div>
                                                    <div class="form-label-group">
                                                        <input type="text" name="mosquename" id="inputMosqueName" class="form-control" placeholder="Mosque Name" required>
                                                        <label for="inputMosqueName">Mosque Name</label>
                                                    </div>
                                                    <div class="divider">
                                                        <div class="divider-text">Data User</div>
                                                    </div>
                                                    <div class="form-label-group">
                                                    ...
                                                    <a href="<?php echo site_url('login');?>" class="btn btn-outline-primary float-left btn-inline mb-50">Login</a>
                                                    <button type="submit" class="btn btn-primary float-right btn-inline mb-50">Signup</a>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
